...
- [x] Mention two parts of Express that you learned about this week.
        ...
        --express is middleware driven, express is easy-ish to use and is 100% customizable

- [x] Describe Middleware?

        -- middleware is code that we right that can do alot of different things to your code, and it can end 2 ways, it can either call the next function, or it return data. 
...
- [x] What can the API return to help clients know if a request was successful?
        ...
        -- the API can return a status code to help know if it was successful..
